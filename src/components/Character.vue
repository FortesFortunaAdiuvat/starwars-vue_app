...
export default {
  ...
  methods: {
    fetchCharacter(id) {
      fetch(`https://swapi.co/api/people/${id}`, {
        method: 'GET'
      }) //uses a Promise to wait for the response, then executes the following code
  ...
  created() {
    //A lifecycle hook so that this fetchCharacter function executes when the component is created
